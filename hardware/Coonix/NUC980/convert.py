...
pos_input_filename = 'NUC980-all.pos'
bom_input_filename = 'NUC980.csv'


pos_output_filename = 'pos_jlc.csv'
bom_output_filename = 'bom_jlc.csv'
